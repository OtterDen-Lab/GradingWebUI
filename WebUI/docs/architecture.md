...
1. **Start Session**: Visit http://localhost:8765
...
```
GradingWebUI/
├── WebUI/                     # Docs and planning notes
│   ├── docs/                  # Documentation
│   └── planning/              # Planning artifacts
├── src/
│   └── grading_web_ui/
│       ├── lms_interface/     # Canvas + AI helpers
...
uvicorn grading_web_ui.web_api.main:app --reload --port 8765
```
